...
export default function Home() {
  ...
  return (
    <main className="flex items-center justify-center flex-col relative">
      <Navbar />
      ...
      <section className="h-screen w-full bg-neutral-950 rounded-md !overflow-visible relative flex flex-col items-center antialiased z-10">
